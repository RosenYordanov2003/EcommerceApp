...
namespace EcommerceApp.Infrastructure.Migrations
{
    ...
    [Migration("20240301153255_addNewEntitiesProductAndShoesOrder")]
    partial class addNewEntitiesProductAndShoesOrder
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcommerceApp.Infrastructure.Data.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EcommerceApp.Infrastructure.Data.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "8846a23e-1587-47cc-b3c7-e88014b3f44d",
                            Email = "admin123@gmail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN123@GMAIL.COM",
                            NormalizedUserName = "АDMIN",
                            PasswordHash = "AQAAAAEAACcQAAAAEIaOuL7XIGpiFNrJo5GteaqbhF12dLHK7lVrB+gOGeoG7qvqC0whdPkm2c6ukDJNew==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "aa58f791-b234-404a-8225-39fe4a37850a",
            ...
            modelBuilder.Entity("EcommerceApp.Infrastructure.Data.Models.UserMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EcommerceApp.Infrastructure.Data.Models.Cart", b =>
                {
                    b.HasOne("EcommerceApp.Infrastructure.Data.Models.User", "User")
                        .WithOne("Cart")
                        .HasForeignKey("EcommerceApp.Infrastructure.Data.Models.Cart", "UserId")
            ...
            modelBuilder.Entity("EcommerceApp.Infrastructure.Data.Models.Product", b =>
                {
                    ...
                    b.HasOne("EcommerceApp.Infrastructure.Data.Models.Category", "Category")
                        .WithMany("Clothes")
            ...
            modelBuilder.Entity("EcommerceApp.Infrastructure.Data.Models.Product", b =>
                {
                    ...
                    b.Navigation("ProductOrderEntities");
