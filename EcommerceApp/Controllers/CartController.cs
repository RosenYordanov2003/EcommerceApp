namespace EcommerceApp.Controllers
{
    ...
    public class CartController : ControllerBase
    {
        ...
        public async Task<IActionResult> FinishOrder([FromBody] OrderModel orderModel)
        {
            ...
            {
                await promotionCodeService.RemoveCouponByIdAsync(orderModel.Cuppon.Id);
            }
            ...
            if (discount > 0)
            {
                CouponModel promotionCode = await promotionCodeService.GenerateCouponForUserAsync(orderModel.UserId, discount);
